...
const CustomTabs: React.FC<ICustomTabsProps> = (props) => {
  ...
  const [isShowLeft, setIshowLeft] = useState<boolean>(false);
  const [isShowRight, setIshowRight] = useState<boolean>(true);
  ...
  const handleScroll = (event: any) => {
    ...
    setIshowLeft(scrollLeft !== 0);
    setIshowRight(scrollWidth > scrollLeft + clientWidth);
  }
